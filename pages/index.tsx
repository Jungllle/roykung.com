  ...
  <Row className="mt-5 align-content-center">
    <Col xs={{span: 12, order: 2}} md={{span: 6, order: 1}}>
      ...
      <p>
        ...
        startup community in Taiwan. Brian and I started it because we
        believed that students should have entrepreneurship. There were 5 demo
        shows and 20 meetups both in Taipei and Tainan, and over 300 students
        participated in.
      </p>
      <p>
      ...
      <p>
        You can find me on{" "}
        <a href="https://twitter.com/roylinkung">Twitter</a>, or drop me an
        Email.
      </p>
    </Col>
